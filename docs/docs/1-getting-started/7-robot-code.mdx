...
:::tip
The FRC coordinate system follows these standards:<br>
X (First value): Positive -> Forwards from robot center<br>
Y (Second value): Positive -> Left from robot center<br>
