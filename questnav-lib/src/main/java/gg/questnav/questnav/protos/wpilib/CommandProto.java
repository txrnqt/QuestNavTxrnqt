 ...
 * 
 * <p>This class provides the necessary integration between QuestNav's protocol buffer
 * command definitions and WPILib's NetworkTables protobuf system. It handles the
 * serialization and deserialization of command messages sent from robot code to
 * the Quest headset.
 * 
 * <p>This adapter is used internally by the {@link gg.questnav.questnav.QuestNav}
 * class and typically does not need to be used directly by robot code.
 * 
 * <h2>Supported Commands</h2>
 * <p>This adapter handles all QuestNav command types including:
 * <ul>
 *   <li><strong>Pose Reset:</strong> Commands to reset the Quest's tracking to a known robot pose</li>
 *   <li><strong>Future Commands:</strong> Extensible for additional command types as needed</li>
 * </ul>
 * 
 * <h2>Protocol Buffer Integration</h2>
 * <p>The class implements WPILib's {@link edu.wpi.first.util.protobuf.Protobuf} interface
 * to provide seamless integration with NetworkTables. This enables:
 * <ul>
 *   <li>Efficient binary serialization over the network</li>
 *   <li>Type-safe message handling</li>
 *   <li>Automatic message validation and error handling</li>
 *   <li>Cross-platform compatibility (Java robot code ↔ C# Quest app)</li>
 * </ul>
 * 
